...
class NotifyCreatedWorkItem extends Mailable
{
    ...
    public function build()
    {
        return $this->from('notification@iPlan.mu')
                     ->subject('A work item has been created on the project "'.$this->project->name.'" on iPlan')
                     ->view('emails.notifications.created-work-item-email')
                     ->with([
                        'user'     => $this->user,
                        'project'  => $this->project,
                        'workItem' => $this->workItem,
                        'title'    => 'A work item has been created on the project"'.$this->project->name.'" on iPlan',
